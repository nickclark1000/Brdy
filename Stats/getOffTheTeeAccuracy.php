<?php
	...
	$resTotHoles = 10;
	$totalFairways = mysql_query("SELECT Count(*) From Shots where ShotNum=2 and ShotFrom='fairway'");
	$resTotFairway = mysql_result($totalFairways,0);
	$totalRough = mysql_query("SELECT Count(*) FROM Shots where ShotNum=2 and ShotFrom='rough'");
